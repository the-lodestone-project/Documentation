...
Lodestone was initially created by [Vercel](https://vercel.com) members
...
[GitHub](https://github.com/shuding/Lodestone/graphs/contributors).

## Credits

Lodestone is powered by these incredible open source projects:
...
Feel free to use the Lodestone logo and other assets in your project. But please
don't modify the logo, and don't use the logo to represent your project or
product.

|    Name     |                   Description                    |           Preview            |
| :---------: | :----------------------------------------------: | :--------------------------: |
|    Icon     | Useful for favicons, app icons, link icons, etc. | ![Lodestone icon](/favicon.svg) |
|    Logo     |                 Full Lodestone logo                 |  ![Lodestone logo](/logo.svg)   |
| Social Card |              The Lodestone social card              |   ![Lodestone card](/og.jpeg)   |

## License

The Lodestone project and themes are licensed under the MIT license.

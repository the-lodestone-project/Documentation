...
A theme in Lodestone works like a layout, that will be rendered as a wrapper for
...
[![](https://vercel.com/button)](https://vercel.com/new/clone?s=https%3A%2F%2Fgithub.com%2Fshuding%2FLodestone-example&showOptionalTeamCreation=false)

## Create a Custom Theme

<Steps>
### Configure Lodestone to Use the Theme

First, you need to tell Lodestone to use your custom theme file instead of official
...
import type { LodestoneThemeLayoutProps } from 'Lodestone'

export default function Layout({ children }: LodestoneThemeLayoutProps) {
  return (
    <div>
      <h1>My Theme</h1>
...
export default function Layout({ children, pageOpts }: LodestoneThemeLayoutProps) {

...
To add multi-language pages to your Lodestone application, you need to config
...
```js
export { locales as middleware } from 'Lodestone/locales'
```

If you already have the middleware defined, you can do this instead:

```js
import { withLocales } from 'Lodestone/locales'

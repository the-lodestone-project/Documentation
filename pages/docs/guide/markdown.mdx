...
With Lodestone, all your `.mdx` files under the pages directory will be rendered
...
Besides basic MDX, Lodestone also has some advanced Markdown features built-in.
...
```md filename="Markdown"
## Long heading about Lodestone [#about-Lodestone]
```

In this example, `#about-Lodestone` will be used as the heading link, replacing the
default `#long-heading-about-Lodestone`.

## Extended Syntax Highlighting

import { StarsIcon } from '@components/icons'
import { Card, Cards } from 'Lodestone/components'

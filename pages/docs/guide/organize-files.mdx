...
Lodestone first collects all your Markdown files and configurations from the
...
<figure>
  <>![Example of Lodestone Theme Docs](/assets/routing@1x.png)</>
  <figcaption>
    Example: [Lodestone Docs Theme](/docs/docs-theme) has sidebar and navbar
...
directory structure, sorted alphabetically. Then, Lodestone will use the
...
And the global page map will be bundled to each page by Lodestone. Then, configured
...
It tells Lodestone the order of each page, and the correct title. Alternatively,

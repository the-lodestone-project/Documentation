...
```js
export default {
  docsRepositoryBase: 'https://github.com/shuding/Lodestone/tree/main/docs'
}
```

Then Lodestone will automatically generate the correct file path for all pages.
...
import { useConfig } from 'Lodestone-theme-docs'
  ...
  head: () => {
    ...
    return (
      <>
        ...
        <meta property="og:title" content={frontMatter.title || 'Lodestone'} />
        <meta
...
<div className="mt-8 text-center text-sm">
  ...
  ↗](https://stackblitz.com/edit/Lodestone-2-docs-yrlccm?file=theme.config.jsx)
</div>
...
it links to Lodestone’s GitHub repository.
...
A banner can be dismissed. By default `banner.key` will be `"Lodestone-banner"` and
it’s used by
...
export default {
  banner: {
    key: '2.0-release',
    text: (
      <a href="https://Lodestone.site" target="_blank">
        🎉 Lodestone 2.0 is released. Read more →
      </a>
    )
  }
}
...
<div className="mt-8 text-center text-sm">
  [Live example on StackBlitz
  ↗](https://stackblitz.com/edit/Lodestone-2-docs-8xbfk3?file=pages%2F_meta.json,theme.config.jsx)
</div>
...
[example](https://github.com/shuding/Lodestone/issues/new?title=Feedback%20for%20%E2%80%9CTheme%20Configuration%E2%80%9D&labels=feedback).

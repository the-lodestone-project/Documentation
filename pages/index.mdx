---
title: Lodestone.py – Create Minecraft bots in Python
---
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Create Minecraft bots <br className='sm:block hidden'/>Lodestone.py</h1>
    <p className="subtitle">Create Minecraft bots with a powerful, stable, <br className='sm:block hidden'/>and high level Python <a className="nextjs-link" href="https://nextjs.org" target="_blank">API.</a></p>
    ...
    <div className="content-container">
      <Features>
        <Feature index={0} large centered id="docs-card" href="/docs/docs-theme/start">
          ...
          <h3>Create Minecraft bots <br className="show-on-mobile"/>in minutes</h3>
        </Feature>
        ...
        <Feature index={3} href="/docs/guide/i18n">
          ...
          <p className='mb-4'>Name your page files with locales suffixed, Lodestone and Next.js will do the rest for you.</p>
          <I18n/>
        </Feature>
        ...
        <Feature index={5} centered className="feat-darkmode" style={{
          ...
          >100+ <br/>examples <br/>included</motion.h3>
        </Feature>
        <Feature index={6} large id="search-card" href="/docs/docs-theme/theme-configuration#search">
          <div style={{ zIndex: 2}}>
            <h3>Ready to go, <br/>zero-config needed</h3>
            <p>Lodestone comes ready-to-go out of the box.</p>
          </div>
        ...
        <Feature index={7} large id="fs-card" style={{
          ...
          <h3>Simple to code, <br/>Lodestone is ready to go in just 2 lines!</h3>
        </Feature>
        <Feature index={8} id="a11y-card" className='card-with-border' style={{
          ...
          <p>Lodestone respects system options <br className="show-on-mobile"/>such as <b>Increase Contrast</b> and <b>Reduce Motion</b>.</p>
        </Feature>
        ...
        <Feature index={10} large>
          ...
          <p className="subtitle"><Link className="!no-underline" href="/docs">Start using Lodestone →</Link></p>
        </Feature>
      </Features>
    </div>
  </div>

      ...
      <Features>
        ...
        <Feature index={6} large id="search-card" href="/docs/docs-theme/theme-configuration#search">
          <div style={{ zIndex: 2}}>
            ...
            <p>Lodestone indexes your content automatically at build-time and performs incredibly fast full-text search via [FlexSearch](https://github.com/nextapps-de/flexsearch).</p>
          </div>
